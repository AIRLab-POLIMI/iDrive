...
void add_meta_for_msg(const typename MsgType::ConstPtr & _msg,  mongo::BSONObjBuilder & _builder, std::string topic) {
	...
	meta.append("topic", topic);

	meta.append("latch", false);
